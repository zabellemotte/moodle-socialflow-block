...
```surveystring``` that you may customize directly from your Moodle administration menu following the [Moodle offical documentation page on langage customization](https://docs.moodle.org/501/en/Language_customisation).
